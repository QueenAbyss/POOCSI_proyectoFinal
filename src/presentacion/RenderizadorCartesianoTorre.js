 ...
 * Especializado en renderizar la gráfica cartesiana interactiva
 */
...
export class RenderizadorCartesianoTorre {
    ...
    dibujarFuncion(funcion) {
        ...
        let firstPoint = true
        const numPoints = 200 // Aumentar resolución
    ...
    dibujarEtiquetas() {
        ...
        this.ctx.fillText('Haz clic para colocar tu estimación de c', this.canvas.width / 2, 45)
