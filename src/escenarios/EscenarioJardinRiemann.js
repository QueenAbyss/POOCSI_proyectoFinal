...
export class EscenarioJardinRiemann extends Escenario {
  ...
  calcularYActualizar() {
    ...
    const datosLogros = {
      errorAbsoluto: error,
      tiempo: this.gestorMetricas.obtenerResumen().tiempo,
      macetas: this.estado.numeroMacetas,
    }
    this.gestorLogros.verificarLogros(datosLogros)
  }
  ...
  obtenerLogros() {
    return this.gestorLogros.obtenerLogros()
  }
